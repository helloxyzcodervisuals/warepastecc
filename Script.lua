...
-- Made By Ahmed discord combatlegnd#0440
...
local network = require(game.ReplicatedStorage.Shared.Vendor.Network) -- network is the place where the remote handling shit is
...
local words = {
    ...
    "the impostor?!?!?!",
    "grass? whats that",
    "having issues playing the game? get .dragonslayer",
